                    ...
                    <div className="p-6">
                        ...
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="creatorName" value={formData.creatorName} onChange={handleFormChange} className="mt-1 block w-full input-style" />
                            </div>
                            <div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="mt-2 flex items-center gap-4">
                                    ...
                                    <button type="button" onClick={() => fileInputRef.current?.click()} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
