                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            {/* Fix: Wrap WarningIcon in a span with a title attribute to provide a tooltip, resolving the TypeScript error where the 'title' prop was incorrectly passed directly to the SVG component. */}
                            {incidentsCount > 0 && <span title={`${incidentsCount} incidencias registradas`}><WarningIcon className="w-4 h-4 text-yellow-500" /></span>}
                        </div>
                    </div>
                </div>
