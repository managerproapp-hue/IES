...
import { UsersIcon, CalendarIcon, TruckIcon, AppleIcon, BookOpenIcon, ClipboardIcon, BriefcaseIcon } from '../../components/icons';
...
const AdminDashboard: React.FC = () => {
    ...
    const { users, suppliers, products, events, orders, services } = useData();

    const personnelCount = users.filter(u => !u.roles.includes(Role.STUDENT) && !u.roles.includes(Role.CREATOR)).length;
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="mt-1 text-gray-600 dark:text-gray-400">Bienvenido, {currentUser?.name}. Aquí tienes un resumen de la actividad.</p>
            </div>
