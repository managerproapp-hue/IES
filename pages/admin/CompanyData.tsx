...
import { Company, Profile, User } from '../../types';
...
export const CompanyData: React.FC = () => {
  ...
  // FIX: Replaced non-existent `Profile.MANAGER` with `Profile.ALMACEN` from the enum.
  const managerUsers = useMemo(() => users.filter(u => u.profiles.includes(Profile.ALMACEN)), [users]);
