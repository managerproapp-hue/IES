...
const UserFormModal: React.FC<{ 
    ...
    const userAssignments = useMemo(() => {
        ...
        return allAssignments
            ...
            .map(a => {
                // FIX: Explicitly typed 'group' and 'module' to resolve type inference issues where Map.get() could be inferred incorrectly.
                const group: Group | undefined = groupMap.get(a.groupId);
                const module: Module | undefined = group ? moduleMap.get(group.moduleId) : undefined;
                return {
                    groupId: a.groupId,
    ...
    return (
        <Modal isOpen={true} onClose={onClose} title={user ? 'Editar Personal' : 'Nuevo Personal'}>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {isSuperUser ? (
                    <div>
                        <label className="font-medium">Perfiles (Super Usuario)</label>
