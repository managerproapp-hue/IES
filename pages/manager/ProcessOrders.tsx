...
import { Event, Order, OrderItem, EventStatus, OrderStatus, Product } from '../../types';
...
const ProcessOrders: React.FC = () => {
    ...
    const { events, orders, orderItems, users, suppliers, products, processEventOrders, reopenProcessedOrders, companyInfo } = useData();
             ...
             <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                    {Array.from(eventStatusMap.entries()).length > 0 ? (
                        ...
                        <p className="text-gray-500">No hay eventos con pedidos para procesar.</p>
                    )}
                </div>
            </div>
        );
