import { User, Profile, SUPER_USER_EMAIL } from '../types';
...
export const users: User[] = [
  ...
  { id: 'user-4', name: 'Super Usuario', email: SUPER_USER_EMAIL, password: 'Proteinas@123', avatar: 'https://i.pravatar.cc/150?u=creator@managerpro.edu', profiles: [Profile.ADMIN, Profile.TEACHER, Profile.ALMACEN, Profile.CREATOR, Profile.STUDENT], activityStatus: 'Activo', locationStatus: 'En el centro', roleType: 'Titular', contractType: 'Fijo', classroomId: 'classroom-1', phone: '655667788', address: 'Plaza del Centro 1', studentSimulatedProfile: Profile.TEACHER },
