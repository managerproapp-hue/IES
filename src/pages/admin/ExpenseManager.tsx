                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {Object.entries(analysisData.costBySupplier).map(([id, cost]) => (
                                <tr key={id} className="border-b dark:border-gray-700"><td className="p-2">{suppliers.find(s=>s.id === id)?.name}</td><td className="p-2">{/* FIX: Cast cost to number to resolve type error from Object.entries. */}
